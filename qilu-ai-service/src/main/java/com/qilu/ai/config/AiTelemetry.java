...
public final class AiTelemetry {
    ...
    private static final OpenTelemetry OPEN_TELEMETRY = buildOpenTelemetry("qilu-ai-service");
    ...
    private static final TextMapSetter<HttpHeaders> HEADERS_SETTER = new TextMapSetter<HttpHeaders>() {
        @Override
    ...
    public static void inject(HttpHeaders headers) {
        OPEN_TELEMETRY.getPropagators().getTextMapPropagator().inject(Context.current(), headers, HEADERS_SETTER);
    }
